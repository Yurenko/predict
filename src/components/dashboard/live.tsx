  ...
  return (
    <Card title="Дослідницькі стратегії">
      <p className="mb-4 text-xs text-zinc-500">
        ...
        старту → Down, вище → Up. Свіжа стрічка може перевернути сторону: 1м на 5м ринку, 5м на 15м.
        Останні 2 хв — лише свічка, не стрічка. Не змішуємо старий 15м lookback у 5м контракт.
