...
const PAPER_SKIP_LABEL: Record<string, string> = {
  ...
  no_near_expiry:
    "немає BTC/ETH/BNB 5m або 15m Up/Down у вікні до експірі",
  waiting_next_horizon:
    "немає нових BTC/ETH/BNB 5m/15m у вікні — відкриті позиції ще в книзі, експірі закриє їх без нового ордера",
