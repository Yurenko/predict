...
const envSchema = z.object({
  ...
  COLLECTOR_MAX_TIME_TO_EXPIRY_SEC: z.coerce.number().int().positive().default(172_800),
  ...
  MAX_ENTRY_ASK: z.coerce.number().min(0).max(1).default(0.55),
  TAKE_PROFIT_MARK: z.coerce.number().min(0).max(1).default(0.45),
  TAKE_PROFIT_MIN_DELTA: z.coerce.number().min(0).max(1).default(0.2),
  TAKE_PROFIT_MIN_TTE_SEC: z.coerce.number().int().nonnegative().default(30),
  STOP_LOSS_DELTA: z.coerce.number().min(0).max(1).default(0.15),
  STOP_LOSS_MARK: z.coerce.number().min(0).max(1).default(0.25),
  EDGE_MIN: z.coerce.number().min(0).max(1).default(0.08),
  EDGE_MAX: z.coerce.number().min(0).max(1).default(1),
  ...
  LLM_CACHE_MS: z.coerce.number().int().positive().default(20_000),
  LLM_PROBE_MS: z.coerce.number().int().positive().default(30_000),
