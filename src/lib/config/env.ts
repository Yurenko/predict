...
const envSchema = z.object({
  ...
  LIVE_TAKE_PROFIT_PRICE: z.coerce.number().min(0).max(1).default(0.98),
  LIVE_TAKE_PROFIT_MIN_TTE_SEC: z.coerce.number().int().nonnegative().default(180),
  LIVE_TRAIL_ACTIVATION_PRICE: z.coerce.number().min(0).max(1).default(0.90),
  LIVE_TRAIL_MIN_DISTANCE: z.coerce.number().positive().default(0.05),
  LIVE_TRAIL_PERCENT: z.coerce.number().positive().default(0.08),
  LIVE_TRAIL_MIN_PROFIT: z.coerce.number().nonnegative().default(0.03),
  LIVE_TRAIL_MIN_TTE_SEC: z.coerce.number().int().nonnegative().default(60),
  LIVE_REVERSAL_MIN_TTE_SEC: z.coerce.number().int().nonnegative().default(180),
  LIVE_REVERSAL_MIN_CONFIDENCE: z.coerce.number().min(0).max(1).default(0.70),
  LIVE_REVERSAL_MIN_NET_EDGE: z.coerce.number().nonnegative().default(0.05),
  LIVE_REVERSAL_MIN_LOSS: z.coerce.number().nonnegative().default(0.005),
